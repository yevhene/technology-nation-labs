...
Курс, на проводиться по программі [CS50 Harvard Introduction in Computer Scienc на платформі edx.org](https://www.edx.org/course/introduction-computer-science-harvardx-cs50x). [Коротка програма курсу](/cs50/course). Ментори вільні корегувати або вносити зміни в программу. Детальний опис курсу та деякі рекомендації зібрані в [окремому документі](/cs50/recommendations). В ході курсу вікористовується браузерна CS50 IDE на базі Cloud9, тобто необхідності встановлювати додаткове ПО самостійно немає необхідності.
...
- Рекомендація додаткових матеріалів та профорієнтація ([додаткові рекомендації](/cs50/additional))
